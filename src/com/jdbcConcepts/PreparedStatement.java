...
//				index starts from one -- column or row index
			...
			// update query
			String updateData = "update employee set FIRSTNAME =? where DESIGNATION = ?";
			pstmt=conn.prepareStatement(updateData);
			pstmt.setString(1, "Lion"); //in first question mark pass lion
			pstmt.setString(2, "chairman"); //in second question mark pass lion
//			? is called placeholder, we dont know what data will be present
//					data can come from ui or external sources
